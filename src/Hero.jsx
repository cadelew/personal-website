...
export default function Hero() {
  return (
    <header className="hero-container" role="banner">
      ...
      <h1 className="hero-title">Caden Lewis</h1>
      <h2 className="hero-subtitle">EECS Student @ UC Berkeley</h2>

      {/* Social buttons */}
      <div className="social-buttons">
        <a href="https://linkedin.com/in/caden-lewis" target="_blank" rel="noopener noreferrer" className="social-button linkedin">
        ...
        <a href="https://github.com/cadelew" target="_blank" rel="noopener noreferrer" className="social-button github">
          <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="mailto:cadelewis2024@gmail.com" className="social-button gmail">
          <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="waves" aria-hidden="true">
        ...
        <div className="wave wave-mid-back"></div>
        <div className="wave wave-mid"></div>
        <div className="wave wave-mid-front"></div>
